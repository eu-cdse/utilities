...
cat << EOF
#usage: $0 options
This utility converts compressed (zipped) Sentinel-1 GRD .SAFE product in .COG format (cloud optimized geotiff) into compressed (zipped) GRD .SAFE product in .tiff.
